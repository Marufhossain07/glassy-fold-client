...
const Newsletter = () => {
    return (
        <div>
            <div className="w-full dark:bg-gray-100 rounded-lg mb-10">
                <div className="container flex flex-col flex-wrap content-center justify-center p-4 py-20 mx-auto md:p-10">
                    ...
                    <div className="flex flex-row">
                        ...
                        <button type="button" className="w-2/5 p-3 font-semibold rounded-r-lg sm:w-1/3 dark:bg-[#2b2d42] dark:text-gray-50">Subscribe</button>
                    </div>
                </div>
            </div>
        </div>
