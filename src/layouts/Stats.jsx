...
const Stats = () => {
    return (
        <div className="pt-5">
            <section className="p-6 my-6 dark:bg-gray-100 rounded-lg text-black">
                <div className="container grid grid-cols-1 gap-6 mx-auto sm:grid-cols-2 xl:grid-cols-4">
                    <div className="flex p-4 space-x-4 rounded-lg md:space-x-6 dark:bg-gray-50 text-black">
                        <div className="flex justify-center p-2 align-middle rounded-lg sm:p-4 dark:bg-[#2b2d42]">
