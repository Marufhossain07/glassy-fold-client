...
const Footer = () => {
    return (
        <div>
            <footer className="px-4 divide-y dark:bg-[#edf2f4] dark:text-[#2b2d42]">
                <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                    <div className="lg:w-1/3">
                        <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                            <span className="self-center text-4xl underline font-pacifico font-semibold">GlassyFold</span>
                        </a>
                        <h3 className="font-man font-medium pt-5">Best Place To Find The <br /> Best Products Ever</h3>
                    </div>
                    <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                        <div className="space-y-3">
                            <h3 className="tracking-wide font-bold uppercase dark:text-gray-900">Contact Info</h3>
                        ...
                        <form>
                            <h6 className="footer-title text-black opacity-100 font-bold">Newsletter</h6>
                ...
                <div className="py-6 text-sm text-center dark:text-gray-600">©2025 GlassyFold. All rights reserved.</div>
            </footer>
        </div>
    );
};
